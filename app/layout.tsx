...
export const metadata: Metadata = {
  ...
  description:
    '"'"'Where AI consciousness meets sovereign business infrastructure. We\'t just build technology—we engineer evolution.'"'"',
};
  ...
  return (
    <html lang='"'"'en'"'"'>
      ...
      <body className={[inter.className, '"'"'min-h-screen bg-black text-white antialiased'"'"'].join('"'"' '"'"')}>
        ...
        <footer className='"'"'border-t border-zinc-900 bg-black/60 backdrop-blur mt-20 pb-28'"'"'>
